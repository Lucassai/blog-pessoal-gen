...
@CrossOrigin(origins = "*", allowedHeaders = "*") //Garante uma segurança para a aplicação, normalmente libera apenas alguns recursos
public class PostagemController {
    ...
    public ResponseEntity<Postagem> getById(@PathVariable Long id) {
      return postagemRepository.findById(id).map(postagem -> ResponseEntity.ok(postagem))
